...
Usage summary: codereview.py [options] [-- diff_options] [path...]
...
DEFAULT_REVIEW_SERVER = "codereview.flipkart.com"
...
def RealMain(argv, data=None):
  ...
  form_fields = [("subject", "[CR] " + message)]
  ...
  cclist = "pricing-dev@flipkart.com,"
  if options.cc:
    for cc in options.cc.split(','):
      CheckReviewer(cc)
    cclist += options.cc
  form_fields.append(("cc", cclist))
